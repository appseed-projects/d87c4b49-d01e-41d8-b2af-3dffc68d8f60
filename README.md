...
> Built with [App Generator](https://appseed.us/generator/), timestamp `2022-10-06 16:17`
...
```bash
$ # Get the code
$ git clone https://github.com/appseed-projects/d87c4b49-d01e-41d8-b2af-3dffc68d8f60.git
$ cd d87c4b49-d01e-41d8-b2af-3dffc68d8f60
```
